...
import { SmqAuthStrategy } from './smq-strategy';
...
describe('password-auth-strategy', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: SmqAuthStrategy, useClass: SmqAuthStrategy },
      ],
    });
  });

  beforeEach(async(inject(
    [SmqAuthStrategy, HttpTestingController],
    (_strategy, _httpMock) => {
      strategy = _strategy;
      httpMock = _httpMock;
