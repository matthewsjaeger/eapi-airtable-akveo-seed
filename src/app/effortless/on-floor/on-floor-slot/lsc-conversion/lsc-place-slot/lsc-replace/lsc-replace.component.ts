...
@Component({
  selector: 'ngx-lsc-replace',
  templateUrl: './lsc-replace.component.html',
  styleUrls: ['./lsc-replace.component.scss']
})
export class LscReplaceComponent extends EffortlessComponentBase implements OnInit {
  ...
  constructor(public gds: GDS, public router: Router, public data: DataEndpoint, protected menuService: NbMenuService,
    public route: ActivatedRoute, protected dialogRef: NbDialogRef<LscReplaceComponent>, private dialogService: NbDialogService, public toastr: NbToastrService) {
