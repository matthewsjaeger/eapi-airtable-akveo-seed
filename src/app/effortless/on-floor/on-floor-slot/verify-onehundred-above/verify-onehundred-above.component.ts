...
@Component({
  selector: 'ngx-verify-onehundred-above',
  templateUrl: './verify-onehundred-above.component.html',
  styleUrls: ['./verify-onehundred-above.component.scss']
})
export class VerifyOnehundredAboveComponent extends EffortlessComponentBase implements OnInit {

  checklist: any = {
    JackpotAmount: '', Book: '', SealIntact: '', RepairRepresentative: '',
    SecurityRepresentative: '', OperationsManager: '', CasinoManager: '', GamingRepresentative: '',
     Verification: '', MediaSignature: ''
  };
