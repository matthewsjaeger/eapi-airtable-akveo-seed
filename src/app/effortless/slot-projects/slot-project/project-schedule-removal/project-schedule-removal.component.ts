...
@Component({
  selector: 'ngx-project-schedule-removal',
  templateUrl: './project-schedule-removal.component.html',
  styleUrls: ['./project-schedule-removal.component.scss']
})
export class ProjectScheduleRemovalComponent extends EffortlessComponentBase implements OnInit {
  slots: any = [];
  project: any = {};
